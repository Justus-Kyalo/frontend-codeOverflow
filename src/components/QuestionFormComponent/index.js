        ...
        <div id="content">
          ...
          <div className="question-and-draft">
            <form id="question-form">
              <div className="label-box">
                ...
                <input
                  ...
                  placeholder="e.g what is switch in react V6 ?"
                ></input>
              </div>
              ...
              <div className="label-box">
                ...
                <div className="tags-input-container">
                  ...
                  <input
                    ...
                    placeholder="e.g. (ruby, javascript, cors, react)"
                  ></input>
                </div>
              </div>
            </form>
            ...
            <aside className="steps-container">
              <div className="steps-title">Draft your question</div>
              <div className="steps">
          ...
          <button className="submit-question" onClick={handleClick}>
            Post your question
          </button>
        </div>
      </div>
